...
#### 2) 파라미터 :: 선박
- name: 선박의 명칭. XX호 이런식으로. 예를들어, 블랙 펄 호. 플라잉 더치맨 호. 말 그대로, 선박의 이름을 뜻한다.
- enumTypeBoat: 현재 선박의 타입. **항해 특화(*속도*)** **전투 특화(*공격력*)** **무역 특화(*최대 하중*)**
- speed: 선박의 속도.
- rotateSpeed: 선박의 선회력.
- durability: 선박의 내구도.
- defence: 선박의 방어력.
- numCannon: 선박의 대포 보유수.
- numCannonMax: 선박의 **최대** 대포 보유수.
